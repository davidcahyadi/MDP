...
from src.models.models import User, Recipe, Ingredient, IngredientType
...
@ingredient.get("/types")
def get_all_types():
    return jsonify(iterateModel(db.session.query(IngredientType).all(), ["id", "name"]))
